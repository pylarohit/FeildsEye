...
import com.rohit.feildseye.databinding.FragmentMainBinding
...
class MainFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding?.soilagriguide?.setOnClickListener {
            findNavController().navigate(R.id.action_mainFragment_to_agriguideFragment)
        }
